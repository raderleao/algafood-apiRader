package com.rader.algafood.api;

import com.rader.algafood.api.controller.*;
...
public class AlgaLinks {
    ...
    public Link linkToRestauranteFormaPagamentoAsassociacao(Long restauranteId, String rel) {
        return linkTo(methodOn(RestauranteFormaPagamentoController.class)
