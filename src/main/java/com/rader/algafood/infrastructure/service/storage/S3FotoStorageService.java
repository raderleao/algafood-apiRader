package com.rader.algafood.infrastructure.service.storage;
...
import com.rader.algafood.core.storage.StorageProperties;
...
public class S3FotoStorageService implements FotoStorageService {
    ...
    public void remover(String nomeArquivo) {
        try{
            ...
            throw new StorageException("Nao foi possível excluir arquivo na Amazon S3", e);
        }
    }
